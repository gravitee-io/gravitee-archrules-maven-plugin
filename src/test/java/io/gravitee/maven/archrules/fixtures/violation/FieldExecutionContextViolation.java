 ...
 * Has an ExecutionContext field but calls logger directly instead of using ctx.withLogger().
 */
public class FieldExecutionContextViolation {

    private final Logger logger;
    private final FakeExecutionContext ctx;

    public FieldExecutionContextViolation(Logger logger, FakeExecutionContext ctx) {
        this.logger = logger;
        this.ctx = ctx;
    }
    ...
    public void process() {
        ...
        logger.info("Processing with field context");
    }
}
