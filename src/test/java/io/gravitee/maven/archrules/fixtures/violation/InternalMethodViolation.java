 ...
 * Has an ExecutionContext parameter and calls a private method that logs directly.
 */
public class InternalMethodViolation {

    private final Logger logger;

    public InternalMethodViolation(Logger logger) {
        this.logger = logger;
    }
    ...
    private void processInternal() {
        ...
        logger.info("Processing internally");
    }
}
